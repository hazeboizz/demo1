	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
			...
			<ul class="nav nav-list">
				...
				<li class="active"><a href="TeaSetup"> <i class="menu-icon fa fa-database"></i> <span class="menu-text">
							开课 </span>
					</a> <b class="arrow"></b>
								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td class="center">
												<form class="no-padding" action="TeaSetup" method="post"
													accept-charset="UTF-8">
													<button class="btn btn-xs btn-info" role="button"
														data-toggle="modal" value="<%=clist.get(i).getCoursenum()%>"
														name="colnum">
														开课
													</button>
												</form>
